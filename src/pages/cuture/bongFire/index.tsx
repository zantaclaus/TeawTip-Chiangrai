  ...
  return (
    <section className='relative h-screen w-screen flex justify-center items-center'>
      ...
      <div className='flex p-12 gap-6 max-w-[1200px] relative '>
        ...
        <div className='w-[800px] text-white px-8 py-12 shadow-xl border-y-8 border-r-8 relative'>
          ...
          <button className='px-6 py-2 mt-6 mb-8 border-2 border-teal-300 rounded-full sukhumvit '>
            เพิ่มเติม
          </button>
        </div>
      </div>
