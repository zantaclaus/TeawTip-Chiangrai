        ...
        <AnimateInView variants={variantText}>
          <div className='w-[600px] h-fit bg-white rounded-xl pl-8 pr-24 py-8 shadow-xl  2xl:w-[620px]'>
            ...
            <h3 className='tagline'>
              เป็นหนึ่งในวัดที่มีความสวยงามทางพุทธศิลป์โดยเกิดจากการสร้างสรรค์ของศิลปินชาวบ้าน คือ
              นายพุทธากาบแก้ว หรือ <Highlight>สล่านก</Highlight>
              เป็นศิลปินท้องถิ่นชาวเชียงรายที่มีโอกาสเข้าไปศึกษา
              ...
              ชาติโดยเฉพาะชาวจีนจุดเด่นของวัดแห่งนี้คือ <Highlight>วิหารร่องเสือเต้น</Highlight>
