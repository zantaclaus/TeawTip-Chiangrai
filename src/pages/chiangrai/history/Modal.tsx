  ...
  return (
    ...
    >
      ...
      <TabPanel value={value} index={1}>
        ...
        หลายคนคงพอทราบแล้วว่า เชียงราย เป็นเมืองเก่าแห่งอาณาจักรล้านนาที่มีประวัติ ความมายาวมากกก
        เรียกว่านานกว่า 700 ปีเลยทีเดียว ตามหลักฐานทางประวัติศาสตร์ บันทึกไว้ว่า เมื่อวันที่ 26
        มกราคม พ.ศ. 1805 หลังจากที่พญามังรายได้รวบรวมหัวเมือง ทางเหนือและเสด็จไปรวมพลที่
        เมืองลาวกู่ต้า ช้างก็พระองค์ก็ได้พลัดหายไปทางทิศตะวันออก พระองค์จึงเสด็จตามรอยช้างไปจนถึง
